...
function setActivePlayer(gameBoard) {
  let currentPlayer = "X";
...
function App() {
  ...
  let active_player = setActivePlayer(gameTurns);

  let gameBoard = [
    ...initialGameBoard.map((arr) => {
      return [...arr];
    }),
  ];
  ...
  return (
    <main>
      <div id="game-container">
        ...
        {(winner || hasDraw) && (
          <GameOver winner={winner} onSelectHandler={handleRestart} />
        )}
